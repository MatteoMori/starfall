...
def run():
    ...
    # Ensure the tool knows which label key to use
    #os.environ["STARFALL_LABEL_KEY"] = "starfall.enabled"

    # Define the inputs for the crew
    # These inputs will be passed to the agents and tasks
    inputs = {
    #     "label_value": "true"
    }
    
    try:
        Starfall().crew().kickoff(inputs=inputs)
